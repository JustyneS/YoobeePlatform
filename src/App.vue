<template>
  ...
  <div id="app">
    ...
    <!-- The AppNavbar component, with a prop for the open state of the navigation and an event listener for the toggle-nav event -->
...
export default {
  ...
  data() {
    return {
      ...
      // The data property for storing the notes
      notes: [],
    };
  },
  watch: {
